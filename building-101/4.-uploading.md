...
If your rom does not boot, ask other maintainers for your device if your device needs specific patches or refer to [Debugging](./5.-debugging.md) in order to grab logs.
